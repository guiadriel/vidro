...
function TRANSPASSE(x) { //COMO CALCULAR O TRANSPASSE
    switch (x) {
        ...
        case "https://calculesuaobra.herokuapp.com/public/img/i18.png": //JANELA quatro folhas --> TRANSPASSE É DE 140 MM
            return 0.09;
            break;
        case "https://calculesuaobra.herokuapp.com/public/img/i19.png": //JANELA quatro folhas --> TRANSPASSE É DE 140 MM
            return 0.09;
            break;
        case "https://calculesuaobra.herokuapp.com/public/img/i20.png": //JANELA quatro folhas --> TRANSPASSE É DE 140 MM
            return 0.09;
            break;
        case "https://calculesuaobra.herokuapp.com/public/img/i21.png": //JANELA quatro folhas --> TRANSPASSE É DE 140 MM
            return 0.09;
            break;
        case "https://calculesuaobra.herokuapp.com/public/img/i22.png": //JANELA quatro folhas --> TRANSPASSE É DE 140 MM
            return 0.09;
            break;
        case "https://calculesuaobra.herokuapp.com/public/img/i23.png": //JANELA quatro folhas --> TRANSPASSE É DE 140 MM
            return 0.09;
            break;
        case "https://calculesuaobra.herokuapp.com/public/img/i24.png": //JANELA quatro folhas --> TRANSPASSE É DE 140 MM
            return 0;
            break;
        case "https://calculesuaobra.herokuapp.com/public/img/i25.png": //JANELA quatro folhas --> TRANSPASSE É DE 140 MM
            return 0;
            break;
        case "https://calculesuaobra.herokuapp.com/public/img/i26.png": //JANELA quatro folhas --> TRANSPASSE É DE 140 MM
            return 0;
            break;
        case "https://calculesuaobra.herokuapp.com/public/img/i27.png": //JANELA quatro folhas --> TRANSPASSE É DE 140 MM
            return 0.09;
            break;
        case "https://calculesuaobra.herokuapp.com/public/img/i28.png": //JANELA quatro folhas --> TRANSPASSE É DE 140 MM
            return 0.09;
            break;
        case "https://calculesuaobra.herokuapp.com/public/img/i29.png": //JANELA quatro folhas --> TRANSPASSE É DE 140 MM
            return 0;
            break;
        case "https://calculesuaobra.herokuapp.com/public/img/i30.png": //JANELA quatro folhas --> TRANSPASSE É DE 140 MM
            return 0;
            break;
        case "https://calculesuaobra.herokuapp.com/public/img/i31.png": //JANELA quatro folhas --> TRANSPASSE É DE 140 MM
            return 0;
            break;
        case "https://calculesuaobra.herokuapp.com/public/img/i32.png": //JANELA quatro folhas --> TRANSPASSE É DE 140 MM
            return 0;
            break;
        case "https://calculesuaobra.herokuapp.com/public/img/i33.png": //JANELA quatro folhas --> TRANSPASSE É DE 140 MM
            return 0;
            break;
        case "https://calculesuaobra.herokuapp.com/public/img/i34.png": //JANELA quatro folhas --> TRANSPASSE É DE 140 MM
            return 0;
            break;
        case "https://calculesuaobra.herokuapp.com/public/img/i35.png": //JANELA quatro folhas --> TRANSPASSE É DE 140 MM
            return 0;
            break;
        case "https://calculesuaobra.herokuapp.com/public/img/i36.png": //JANELA quatro folhas --> TRANSPASSE É DE 140 MM
            return 0;
            break;
        case "https://calculesuaobra.herokuapp.com/public/img/i37.png": //JANELA quatro folhas --> TRANSPASSE É DE 140 MM
            return 0;
            break;
...
function fParcela() {
    var parcelado = (parseFloat(soma123) + parseFloat(document.getElementById("maoDeObra").value)) / document.getElementById("nparcelas").value;
    for (i = 1; i <= 12; i++) {
...
function trocaAba(abaClicada) {
    ...
    document.getElementById("spanBasc").style.backgroundColor = "rgb(134, 134, 134)";
    document.getElementById("spanJane").style.backgroundColor = "rgb(134, 134, 134)";
    document.getElementById("spanPort").style.backgroundColor = "rgb(134, 134, 134)";
    document.getElementById("spanOutr").style.backgroundColor = "rgb(134, 134, 134)";
    document.getElementById("spanEsqu").style.backgroundColor = "rgb(134, 134, 134)";
    switch (abaClicada) {
        case 1:
            document.getElementById("fundoBasculantes").style.visibility = "visible";
            document.getElementById("spanBasc").style.backgroundColor = "rgb(82, 77, 77)";
            document.getElementById("spanBasc").style.color = "white";
            break;
        case 2:
            document.getElementById("fundoJanelas").style.visibility = "visible";
            document.getElementById("spanJane").style.backgroundColor = "rgb(82, 77, 77)";
            document.getElementById("spanJane").style.color = "white";
            break;
        case 3:
            document.getElementById("fundoPortas").style.visibility = "visible";
            document.getElementById("spanPort").style.backgroundColor = "rgb(82, 77, 77)";
            document.getElementById("spanPort").style.color = "white";
            break;
        case 4:
            document.getElementById("fundoOutros").style.visibility = "visible";
            document.getElementById("spanOutr").style.backgroundColor = "rgb(82, 77, 77)";
            document.getElementById("spanOutr").style.color = "white";
            break;
        case 5:
            document.getElementById("fundoEsquadrilhas").style.visibility = "visible";
            document.getElementById("spanEsqu").style.backgroundColor = "rgb(82, 77, 77)";
...
function delRow(i, j) {
    ...
    document.getElementById("soma1234").innerHTML = parseFloat   (         (    parseFloat(    document.getElementById("soma1234").innerHTML.replace('.','')    )     -    parseFloat(j[8].firstChild.innerHTML)  )    );
    console.log("document.getElementById('soma1234').innerHTML: " + document.getElementById("soma1234").innerHTML); //100 mao de obra
...
function pdfcanvas(){
    html2canvas(document.querySelector("body")).then(canvas => {
        ...
        document.getElementById("box1").attr('href', canvas.toDataURL("img/png"));
        document.getElementById("box1").attr('donwload', 'Teste file.png');
        document.getElementById("box1")[0].click();
    });
}