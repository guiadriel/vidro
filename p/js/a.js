...
onload = function() {
    Mudarestado("fundo");
    Mudarestado("fundo2");
    document.getElementById("bt").src = "img/i01.png";
    document.getElementById("cor").src = "img/v01.png";
    xAtualiza('i01');
    yAtualiza('v01');
    Mudarestado('fundo');
    Mudarestado('fundo2');
...
function xAtualiza(x) {
    ...
    switch (x) {
        ...
        case "i02":
            ...
            document.getElementById("bt").src = "img/i02.png";
            break;
        case "i03":
            document.getElementById("xFator").value = 5;
            ...
            document.getElementById("xKit").value = 90.00;
            document.getElementById("bt").src = "img/i03.png";
            break;
        case "i04":
            document.getElementById("xFator").value = 3;
            document.getElementById("xDiversos").value = 7;
            ...
            document.getElementById("xKit").value = 90.00;
            document.getElementById("bt").src = "img/i04.png";
            break;
        case "i05":
            document.getElementById("xFator").value = 5;
            document.getElementById("xDiversos").value = 7;
            ...
            document.getElementById("xKit").value = 90.00;
            document.getElementById("bt").src = "img/i05.png";
            break;
        case "i06":
            document.getElementById("xFator").value = 3;
            document.getElementById("xDiversos").value = 7;
            ...
            document.getElementById("xKit").value = 0;
            document.getElementById("bt").src = "img/i06.png";
            break;
        case "i07":
            document.getElementById("xFator").value = 3;
            document.getElementById("xDiversos").value = 7;
            ...
            document.getElementById("xKit").value = 0;
            document.getElementById("bt").src = "img/i07.png";
            break;
        case "i08":
            ...
            document.getElementById("xKit").value = 0;
            document.getElementById("bt").src = "img/i08.png";
            break;
        case "i09":
            document.getElementById("xFator").value = 5;
            document.getElementById("xDiversos").value = 7;
            ...
            document.getElementById("bt").src = "img/i09.png";
            break;
        case "i10":
            ...
            document.getElementById("xFerro").value = 0;
            document.getElementById("xKit").value = 0;
            document.getElementById("bt").src = "img/i10.png";
            t = 7;
        ...
        case "i11":
            ...
            document.getElementById("xKit").value = 0;
            document.getElementById("espessura").value = "4mm";
            document.getElementById("bt").src = "img/i11.png";
            t = 6;
            yAtualiza2();
            break;
        case "i12":
            ...
            document.getElementById("xFerro").value = 0;
            document.getElementById("xKit").value = 0;
            document.getElementById("bt").src = "img/i12.png";
            t = 8;
            yAtualiza2();
            break;
        case "i13":
            ...
            document.getElementById("xFerro").value = 0;
            document.getElementById("xKit").value = 0;
            document.getElementById("bt").src = "img/i13.png";
            t = 9;
            yAtualiza2();
            break;
        case "i14":
            ...
            document.getElementById("xFerro").value = 0;
            document.getElementById("xKit").value = 0;
            document.getElementById("bt").src = "img/i14.png";
        ...
        case "i15":
            ...
            document.getElementById("xFerro").value = 0;
            document.getElementById("xKit").value = 0;
            document.getElementById("bt").src = "img/i15.png";
            t = 8; // Envia para o mesmo valor do case 12  (600)
            yAtualiza2();
            break;
        case "i16":
            ...
            document.getElementById("xFerro").value = 0;
            document.getElementById("xKit").value = 0;
            document.getElementById("bt").src = "img/i16.png";
        ...
        case "i17":
            ...
            document.getElementById("xFerro").value = 0;
            document.getElementById("xKit").value = 0;
            document.getElementById("bt").src = "img/i17.png";
            t = 10;
            yAtualiza2();
            break;
        case "i18":
            ...
            document.getElementById("xFerro").value = 0;
            document.getElementById("xKit").value = 0;
            document.getElementById("bt").src = "img/i18.png";
            t = 8; // Envia para o mesmo valor do case 12  (600)
            yAtualiza2();
            break;
...
function yAtualiza(y) {
    switch (y) {
        case "v01": // Vidrof INCOLOR
            ...
            break;
        case "v02": // Vidro FUMÊ
            document.getElementById("cor").src = "img/v02.png";
            t = 2;
            yAtualiza2();
            break;
        case "v03":
            ...
            break;
        case "v04":
            document.getElementById("cor").src = "img/v04.png";
            t = 4;
            yAtualiza2();
            break;
        case "v05":
            document.getElementById("cor").src = "img/v05.png";
            t = 5;
            yAtualiza2();
            break;
        default:
